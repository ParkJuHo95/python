...
form_class = uic.loadUiType("my_Ai.ui")[0]
    ...
    def __init__(self) :
        ...
        for i in range(20):
            ...
            for j in range(20):
                ...
                btn.clicked.connect(self.stone)
...
#--------------------------------------------------------------------------------------------------------------------
    def comClick(self):
        ...
        out400 = np.argmax(output)
        print("output.argmax",np.argmax(output))
